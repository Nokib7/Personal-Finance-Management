...
import 'package:money_management/pages/input_page.dart';
import 'package:money_management/pages/updatePage.dart';
...
class _HomePageState extends State<HomePage> {
      ...
      child: ToggleButtons(
        ...
        children: <Widget>[
          ...
          Container(
              ...
              child: new Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[Text("수입")],
              )),
          Container(
              width: (MediaQuery.of(context).size.width - 36) / 3,
              child: new Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: <Widget>[Text("지출")],
              )),
        ],
      ...
      child: Card(
        ...
        child: ListTile(
          ...
          trailing: breakdown.type == 'income'
              ? Text(
                  '${FlutterMoneyFormatter(amount: breakdown.cost.toDouble()).output.withoutFractionDigits}원',
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Row(
          children: <Widget>[
            Text(
              '남은 돈 : ${FlutterMoneyFormatter(amount: breakdowns.totalMoney.toDouble()).output.withoutFractionDigits}원',
              style: TextStyle(
                fontSize: 20,
              ),
            ),
  ...
  itemClick(Breakdown breakdown) {
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => UpdatePage(breakdown: breakdown,)));
  }
}
